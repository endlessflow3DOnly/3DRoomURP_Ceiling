    ...
    public class LCRSManager : MonoBehaviour
    {
        ...
        public void InitializeProperties()
        {
            ...
            if (renderers != null && renderers.Length > 0)
            {
                ...
                {
                    if (ren?.materials != null && ren.materials.Length > 0)
                    {
        ...
        public void CreateBoundsAndSetPositions(Renderer ren, Material mat)
        {
            ...
            ////ren.material.SetTexture("_EnviCubeMapMain", _probe.texture);
            //ren.material.SetTexture("_EnviCubeMapMain", _cube);
            //ren.material.SetTexture("_EnviCubeMapToMix1", found == null ? null : found.texture);
            //ren.material.SetFloat("_MixMultiplier", _MixMultiplier);
            ////ren.material.SetFloat("_EnviCubeSmoothness", Smoothness); //moved to main shader
            ////ren.material.SetFloat("_EnviCubeIntensity", Intensity); //moved to main shader
            //if (MixOtherProbes)
            //    ren.material.EnableKeyword("_REALTIMEREFLECTION_MIX");
            //else
            //    ren.material.DisableKeyword("_REALTIMEREFLECTION_MIX");
